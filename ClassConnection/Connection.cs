...
namespace ClassConnection
{
    public class Connection
    {
        ...
        public static void Connect()
        {
            try
            {
                string Path = $@"Server=DESKTOP-JPS19OC\SQLEXPRESS;Database=base1_ISP_21_4_2;Trusted_Connection=True;User Id=sa;Password=root";
        ...
        public void LoadData(Tables table)
        {
            ...
            switch (table)
            {
                ...
                case Tables.SocialScholarships:
                    ...
                    while (reader.Read())
                    {
                        SocialScholarships scholarship = new SocialScholarships
                        {
                            ...
                            //Files = reader.IsDBNull(6) ? null : (string)reader.GetValue(5)
                ...
                case Tables.Students:
                    ...
                    while (reader.Read())
                    {
                        int StudentId = Convert.ToInt32(reader.GetValue(0));
                        string LastName = Convert.ToString(reader.GetValue(1));
                        string FirstName = Convert.ToString(reader.GetValue(2));
                        string MiddleName = Convert.ToString(reader.GetValue(3));
                        DateTime BirthDate = Convert.ToDateTime(reader.GetValue(4));
                        string Gender = Convert.ToString(reader.GetValue(5));
                        string ContactNumber = Convert.ToString(reader.GetValue(6));
                        string Obrazovanie = Convert.ToString(reader.GetValue(7));
                        int Otdelenie = Convert.ToInt32(reader.GetValue(8));
                        string Groups = Convert.ToString(reader.GetValue(9));
                        string Finance = Convert.ToString(reader.GetValue(10));
                        int YearPostup = Convert.ToInt32(reader.GetValue(11));
                        int YearOkonch = Convert.ToInt32(reader.GetValue(12));
                        string InfoOtchiz = Convert.ToString(reader.GetValue(13));
                        DateTime DateOtchiz = Convert.ToDateTime(reader.GetValue(14));
                        string Note = Convert.ToString(reader.GetValue(15));
                        string ParentsInfo = Convert.ToString(reader.GetValue(16));
                        string Vziskanie = Convert.ToString(reader.GetValue(17));
                        string Files = Convert.ToString(reader.GetValue(18));
                        Students student = new Students
                        {
                            ...
                            Groups = Groups,
                            Finance = Finance,
                            YearPostup = YearPostup,
                            YearOkonch = YearOkonch,
                            InfoOtchiz = InfoOtchiz,
                            DateOtchiz = DateOtchiz,
                            Note = Note,
